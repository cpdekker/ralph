...
run_completion_check() {
    ...
    if [ "$is_complete" = "true" ]; then
        ...
        echo ""
        echo -e "\033[1;35m════════════════════════════════════════════════════════════\033[0m"
        echo -e "\033[1;35m  🛑 BLOCKED ON USER — All agent work complete\033[0m"
        [ -n "$confidence" ] && echo -e "\033[1;35m  Confidence: ${confidence}\033[0m"
        echo -e "\033[1;35m════════════════════════════════════════════════════════════\033[0m"
        [ -n "$reason" ] && echo -e "  \033[1;36m$reason\033[0m"
        echo ""

        # Generate user-intervention.md
...
FOOTEREOF
    ...
    echo -e "  \033[1;35m📋\033[0m Created \033[1;37m.ralph/user-intervention.md\033[0m — review and provide answers to unblock"
}
...
USERREVIEWEOF
        ...
        if [ $COMPLETION_RESULT -eq 0 ]; then
            ...
            echo -e "  \033[1;35m🛑\033[0m Ralph is blocked on user intervention. Stopping iterations."
            echo -e "  \033[1;35m📋\033[0m Review \033[1;37m.ralph/user-intervention.md\033[0m and provide answers."
            echo -e "  \033[1;35m💡\033[0m Drop reference files in \033[1;37m.ralph/references/\033[0m if needed."
            echo -e "  \033[1;35m→\033[0m  Re-run Ralph after responding to resume."
